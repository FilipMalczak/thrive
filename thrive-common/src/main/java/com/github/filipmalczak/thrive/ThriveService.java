...
import com.github.filipmalczak.thrive.infrastructure.ThriveCoreConfig;
 ...
 * (available with {@link com.github.filipmalczak.thrive.infrastructure.SimpleWebClient SimpleWebClient} qualifier),
...
@PropertySource({"classpath:/git.properties", "classpath:/META-INF/build-info.properties", "classpath:/discovery.properties"})
